...
import DiscoBallHeroBackground from './DiscoBallHeroBackground';
...
export default function HomeHeader() {
  ...
  return (
    ...
    >
      {/* Disco ball — absolutely positioned behind all text */}
      <DiscoBallHeroBackground />
      {/* Text content — sits above disco ball */}
